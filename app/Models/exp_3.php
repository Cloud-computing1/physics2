...
class exp_3 extends Model
{
    // 指定数据表
    protected $table = "exp_3";
    // 指定开启时间戳
    ...
    public static function find_someone($stu_id)
    {
        try {
            ...
            logError('在实验三中查找学生失败！', [$e->getMessage()]);
            return false;
        }
    }
    ...
    public static function del_someone($stu_id)
    {
        try {
            ...
            logError('在实验三中删除学生失败！', [$e->getMessage()]);
            return false;
        }
    }
    ...
    public static function find_someclass($class)
    {
        try {
            ...
            logError('在实验三中查找班级' . $class . '失败！', [$e->getMessage()]);
            return false;
        }
    }
